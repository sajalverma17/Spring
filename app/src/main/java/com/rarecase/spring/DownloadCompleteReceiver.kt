        ...
        if(intent?.action == DownloadManager.ACTION_DOWNLOAD_COMPLETE) {
            if(context?.packageName == "com.rarecase.spring") {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    val song = getSongDetails(context,songId)               //Get cached metadata of song
                    removeSongDetailsFromCache(context,songId)              //Then delete cache so same song can be downloaded by user later
